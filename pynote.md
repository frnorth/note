...
## &ensp; arraybag.py
[sp]&ensp;&ensp;&ensp;&ensp
&ensp;&ensp;&ensp; if not item in arraybag1:    
&ensp;&ensp;&ensp; not ... in 就是遍历了arraybag1, 是由__contain__方法实现的?

[sp] for i in self: 而不是 for i in self._items: 是因为 __iter__ 方法, 直接__iter__(self), 就可以返回self._item._data
